...
export declare const cityForeign: string[];
export declare const placeForeign: string[];
export declare const regionForeign: string[];
export declare const areaForeign: string[];
